...
export const feed = [
  {
    ...
    workout: 'corrida', // <-- Alterado de 'workout' para 'category'
  ...
  },
  {
    ...
    workout: 'caminhada', // <-- Alterado de 'workout' para 'category'
    description: 'Corrida rápida no final do dia. Preciso melhorar a resistência, mas foi um bom treino! Ver mais',
  ...
  },
  {
    ...
    workout: 'caminhada', // <-- Alterado de 'workout' para 'category'
    description: 'Long run de domingo! Que sensação incrível completar os 10km. Cada vez mais perto da meta da meia maratona',
  ...
  },
  {
    ...
    workout: 'caminhada', // <-- Alterado de 'workout' para 'category'
    description: 'Primeiro treino da semana! Voltando ao ritmo depois do final de semana. Vamos com tudo! Ver mais',
  ...
  },
  {
    ...
    workout: 'treino', // <-- Alterado de 'workout' para 'category'
